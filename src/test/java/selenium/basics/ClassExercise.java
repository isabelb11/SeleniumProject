...
public class ClassExercise {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
        ...
        emailField.sendKeys("transformers.test@tekschool.us"); // write your own username
        ...
        wait.until(ExpectedConditions.presenceOfElementLocated                (By.cssSelector("div[class='account__address-new-wrapper']")));
